...
// 	exitWithError("Unable to create a CPU timer as all $ CPU timers are currently running.", cpuTimerCount);
// }
...
// 	exitWithError("Unable to create a clock timer as all $ clock timers are currently running.", clockTimerCount);
// }
