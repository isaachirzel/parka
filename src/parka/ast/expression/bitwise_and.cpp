...
bool BitwiseAndExpression::validate(LocalSymbolTable& symbols)
{
	exitNotImplemented(here());
}

Optional<Type> BitwiseAndExpression::getType(const LocalSymbolTable& symbolTable, Ref<Type> expected) const
{
	exitNotImplemented(here());
}
