#ifndef PARKA_VALIDATOR_STRUCT_VALIDATOR_HPP
#define PARKA_VALIDATOR_STRUCT_VALIDATOR_HPP
...
namespace parka::validator
{
	class StructSymbolTable//: public Resolvable
	{
		...
		// friend std::ostream& operator<<(std::ostream& out, const StructValidator& validator);
	};
}
